...
public class SignInActivity extends BaseActivity implements
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(getApplicationContext(), "uid는 " + user.getUid(), Toast.LENGTH_LONG).show();
                    onAuthSuccess(user);
                } else {
                    // User is signed out
    ...
    // [START basic_write]
    private void writeNewUser(String userId, String name, String email, String url) {
