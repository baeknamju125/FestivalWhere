...
import com.google.firebase.quickstart.database.viewholder.FestivalViewHolder;
            ...
            protected void populateViewHolder(final FestivalViewHolder viewHolder, final Festival model, final int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(getActivity().getApplicationContext(), "postKey:"+postKey,Toast.LENGTH_SHORT).show();;
